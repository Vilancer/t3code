...
/** Held only by mirror peer links (the file-owning environment's
    MirrorAgent). Never part of the standard or administrative client
    scope sets. */
export const AuthMirrorSyncScope = "mirror:sync" as const;
